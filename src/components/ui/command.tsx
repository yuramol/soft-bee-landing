...
>(({ className, ...props }, ref) => (
  <div className='border-blue-light flex items-center border-b px-3' cmdk-input-wrapper=''>
    <MagnifyingGlassIcon className='mr-2 size-5 shrink-0 opacity-50' />
    <CommandPrimitive.Input
      ref={ref}
      className={cn(
        'placeholder:text-muted-foreground text-body3 flex h-10 w-full rounded-md bg-transparent py-3 outline-none disabled:cursor-not-allowed disabled:opacity-50',
        className
      )}
      {...props}
    />
...
>((props, ref) => <CommandPrimitive.Empty ref={ref} className='text-body3 py-6 text-center' {...props} />);
