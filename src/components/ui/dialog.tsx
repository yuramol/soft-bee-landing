  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        'fixed top-1/2 left-1/2 z-51 grid h-[calc(100%-2rem)] max-h-268 w-[calc(100vw-1rem)] max-w-221 min-w-0 -translate-x-1/2 -translate-y-1/2 gap-4 overflow-x-hidden rounded-2xl bg-white p-3 shadow-lg duration-200',
        'overflow-y-auto',
        className
      )}
      {...props}
