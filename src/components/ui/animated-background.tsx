...
export const AnimatedBackground = ({ className }: AnimatedBackgroundProps) => {
  return (
    <div
      ...
      style={{
        maskImage: 'linear-gradient(to bottom, transparent 0%, black 20%, black 50%, transparent 100%)',
        WebkitMaskImage: 'linear-gradient(to bottom, transparent 0%, black 20%, black 50%, transparent 100%)'
      }}
    >
