...
export const VacancyCard = ({ badge, title, description, link = ROUTES.CAREERS }: VacancyCardProps) => {
  return (
    <Link
      href={link}
      className='group bg-muted relative flex h-auto min-h-77.75 w-full flex-col justify-between overflow-hidden rounded-lg p-4 md:min-h-93.75 md:p-8'
    >
