        ...
        <div className='flex flex-col gap-2.5 xl:gap-8.75'>
          <div className='w-full'>
            <Image
              ...
              width={1816}
              height={1020}
              className='aspect-490/539 h-auto w-full rounded-md object-cover xl:aspect-auto xl:rounded-4xl'
            />
          </div>
            ...
            {images.slice(1).map((img, idx) => (
              <div key={idx} className='w-full xl:flex-1'>
                <Image
                  ...
                  width={890}
                  height={822}
                  className='h-auto w-full rounded-md object-cover xl:rounded-4xl'
                />
              </div>
            ))}
          </div>
