...
export const LogoGoogleCloudDialogflowCX = (style: IconCommonProps) => (
  <svg width='128' height='128' style={style} className={style.className} xmlns='http://www.w3.org/2000/svg' role='img' viewBox='0 0 24 24'>
